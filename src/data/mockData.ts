...
export const COURSE_EMBLEMS: Record<string, string> = {
  ...
  'Enfermagem - Unisanta': 'enfermagem-unisanta.png.png',
  ...
  'Medicina Veterinária - Unimes': 'medicinaveterinaria-unimes.png.png',
...
export const mockRanking: RankingEntry[] = [
  ...
  { rank: 33, course: 'Biomedicina - Unisanta', points: 0 },
  { rank: 34, course: 'Ciên. Educ. - Unisantos', points: 0 },
  { rank: 35, course: 'Engenharia - ESAMC', points: 0 },
  { rank: 36, course: 'FACECS - Unisantos', points: 0 },
  { rank: 37, course: 'Farmácia - Unisanta', points: 0 },
  { rank: 38, course: 'Fisioterapia - Unifesp', points: 0 },
  { rank: 39, course: 'Medicina Veterinária - São Judas', points: 0 },
  { rank: 40, course: 'Medicina Veterinária - Unimes', points: 0 },
  { rank: 41, course: 'Odonto - São Judas', points: 0 },
  { rank: 42, course: 'Rel. Internacionais - Unisanta', points: 0 }
];
